  ...
  return (
    <Box
      sx={{
        minHeight: "100vh",
        background:
          "radial-gradient(circle at top left, rgba(18, 102, 214, 0.10), transparent 28%), radial-gradient(circle at right, rgba(77, 148, 238, 0.10), transparent 24%), linear-gradient(180deg, #f6f8fc 0%, #edf3fb 48%, #f6f8fc 100%)",
        pb: { xs: 9, md: 0 },
      }}
    >
      <AppBar
