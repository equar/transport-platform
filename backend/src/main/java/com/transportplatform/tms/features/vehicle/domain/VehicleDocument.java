...
public class VehicleDocument extends AuditableEntity {
    ...
    private VehicleDocumentVerificationStatus verificationStatus;
    ...
    public VehicleDocumentVerificationStatus getVerificationStatus() {
        return verificationStatus;
    }

    public void setVerificationStatus(VehicleDocumentVerificationStatus verificationStatus) {
        this.verificationStatus = verificationStatus;
    }

    public VehicleDocumentStatus getStatus() {
        return status;
    }

    public void setStatus(VehicleDocumentStatus status) {
        this.status = status;
    }
