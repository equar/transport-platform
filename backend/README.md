...
Email delivery uses SMTP when `SPRING_MAIL_HOST` is configured. If SMTP is not configured, the backend falls back to logging notification email attempts instead of sending them.
